...
<!-- PROJECT SHIELDS -->
[![Contributors][contributors-shield]](https://github.com/Pronti-Beam/demos-experiments/graphs/contributors)
...
<!-- PROJECT LOGO -->
<br />
  <h3 align="center"> Pronti - Wardrobe Assistant demos and experiments</h2>
  <p align="center">
    A One-stop shop for active notebooks and research in the field of segmentation, image classification and optimization<br />
    <a href="https://github.com/beam-data/nuportai/wiki"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <img src="data/pronti.png" align="middle">
    <br />
    <br />
...
All necessary dependencies have been included in the currently active notebooks, and requirements will be provided for frozen environments once work on any cloud VM/local server implementations has reached a stable version.
